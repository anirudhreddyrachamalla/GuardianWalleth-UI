...
function SearchInput() {
    ...
    function handleApprove() {
      // Code to handle the approval goes here
...
<Header/>
  ...
  <div>
    <div class="font-semibold text-lg">Address : 0xgau873v543v79389dk</div>
    <div class="text-xs text-gray-500">
      <span class="mr-2">Amount: 2ETH</span>
    </div>
  </div>
  <div class="ml-auto flex items-center">
    <button class="mr-2 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Revoke</button>
    <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" onClick={handleApprove}>Approve</button>
  </div>
</div>
        ...
        <div class="w-full flex p-3 pl-4 items-center hover:bg-gray-300 rounded-lg cursor-pointer">
          ...
          <div>
             ...
             <div class="font-semibold text-lg">Address: 0x43kwd8fsv543v79389s</div>
            <div class="text-xs text-gray-500">
              <span class="mr-2">Amount: 4XRP</span>
            </div>
          </div>
          <div class="ml-auto flex items-center">
    <button class="mr-2 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Revoke</button>
    <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" onClick={handleApprove}>Approve</button>
        ...
        <div class="w-full flex p-3 pl-4 items-center hover:bg-gray-300 rounded-lg cursor-pointer">
          ...
          <div>
             ...
             <div class="font-semibold text-lg">Address: 0x43kwd8fsvgw2j29hsv2</div>
            <div class="text-xs text-gray-500">
              <span class="mr-2">Amount: 2BTC</span>
            </div>
          </div>
          <div class="ml-auto flex items-center">
    <button class="mr-2 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Revoke</button>
